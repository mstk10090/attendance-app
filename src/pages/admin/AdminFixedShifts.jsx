// src/pages/admin/AdminFixedShifts.jsx
...
export default function AdminFixedShifts() {
  ...
  useEffect(() => {
    const fetchFixedShifts = async () => {
      ...
      try {
        ...
        console.log("Admin FixedShifts raw:", text);
        ...
        console.log("Admin FixedShifts parsed:", data);
        ...
        console.error("Admin FixedShifts fetch error:", err);
            ...
            {days.map((d) => {
              ...
              return (
                <div
                  ...
                  style={todayStyle}
                  // ★ 管理者用：詳細は /admin/shifts/:date に飛ばす
                  onClick={() => navigate(`/admin/shifts/${dateStr}`)}
                >
